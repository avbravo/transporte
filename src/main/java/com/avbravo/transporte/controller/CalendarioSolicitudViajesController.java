...
// <editor-fold defaultstate="collapsed" desc="handleSelectEstatus(SelectEvent event)">
    ...
    public void handleSelectEstatusTipovehiculo(SelectEvent event) {
        try {
            ...
            cargarSchedule(false);

        } catch (Exception e) {
            errorServices.errorMessage(nameOfClass(), nameOfMethod(), e.getLocalizedMessage());
        }
    }// </editor-fold>
// <editor-fold defaultstate="collapsed" desc="cargarSchedule(Boolean start)">
...
//            // temp = solicitudRepository.findRegex(field, query, true, new Document(field, 1));
//            Document doc = new Document();
//            doc.append("activo", "si").append("realizado", "no");
//            temp = viajesRepository.findBy(doc, new Document("idsolicitud", -1));
//
//            if (temp.isEmpty()) {
//                return suggestions;
//            } else {
