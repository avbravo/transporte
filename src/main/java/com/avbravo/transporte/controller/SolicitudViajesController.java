...
public class SolicitudViajesController implements Serializable, IController {
...
// <editor-fold defaultstate="collapsed" desc="constructor">
    public SolicitudViajesController() {
    }
            ...
            switch (getSearch()) {
                ...
                case "idsolicitud":
                    if (getValueSearch() != null) {
                        ...
                        doc = new Document("idsolicitud", solicitudSearch.getIdsolicitud()).append("activo", "si");
                        solicitudList = solicitudRepository.findPagination(doc, page, rowPage, new Document("idsolicitud", -1));
                    } else {
...
// </editor-fold>
    ...
    public String showSolicita(Solicitud solicitud){
        try {
            ...
            return solicitud.getUsuario().get(0).getNombre();
