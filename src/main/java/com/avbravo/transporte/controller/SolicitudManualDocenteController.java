        ...
        try {
            ...
            switch (getSearch()) {
                ...
                case "_autocomplete":
                    ...
                    doc = new Document("tiposolicitud.idtiposolicitud", "DOCENTE").append("activo", "si");
                ...
                case "idsolicitud":
                    if (getValueSearch() != null) {
                        ...
                        doc = new Document("idsolicitud", solicitudSearch.getIdsolicitud()).append("tiposolicitud.idtiposolicitud", "DOCENTE").append("activo", "si");
                        solicitudList = solicitudRepository.findPagination(doc, page, rowPage, new Document("idsolicitud", -1));
                    } else {
                ...
                case "estatus":
                    ...
                    doc = new Document("estatus.idestatus", estatus.getIdestatus()).append("activo", "si").append("tiposolicitud.idtiposolicitud", "DOCENTE");
                    solicitudList = solicitudRepository.findPagination(doc, page, rowPage, new Document("idsolicitud", -1));
