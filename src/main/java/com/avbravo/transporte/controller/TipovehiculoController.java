...
//        com.lowagie.text.Document document = new com.lowagie.text.Document(PageSize.A4.rotate());
        ...
        try {
            ...
            document.open();
            document.add(ReportUtils.paragraph("TIPO VEHICULO", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
...
//Aqui indicamos el tamaño de cada columna
            ...
            for (Tipovehiculo tv : tipovehiculoList) {
                ...
                table.addCell(ReportUtils.PdfCell(tv.getIdtipovehiculo(), FontFactory.getFont("arial", 10, Font.NORMAL)));
                
                table.addCell(ReportUtils.PdfCell(tv.getActivo(), FontFactory.getFont("arial", 10, Font.NORMAL)));
    ...
    public String print() {
        ...
        try {
            ...
            document.add(ReportUtils.paragraph("Id: " + tipovehiculo.getIdtipovehiculo(), FontFactory.getFont("arial",12, Font.NORMAL), Element.ALIGN_JUSTIFIED));
            
            document.add(ReportUtils.paragraph("Activo: " + tipovehiculo.getActivo(), FontFactory.getFont("arial", 12, Font.NORMAL), Element.ALIGN_JUSTIFIED));
