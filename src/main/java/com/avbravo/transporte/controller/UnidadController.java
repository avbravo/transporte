...
//        com.lowagie.text.Document document = new com.lowagie.text.Document(PageSize.A4.rotate());
        ...
        try {
            ...
            document.open();
            document.add(ReportUtils.paragraph("UNIDADES", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
...
//Aqui indicamos el tamaño de cada columna
            table.setTotalWidth(new float[]{140, 140});
            ...
            for (Unidad u:unidadList) {

                table.addCell(ReportUtils.PdfCell(u.getIdunidad(), FontFactory.getFont("arial", 10, Font.NORMAL)));
                
                table.addCell(ReportUtils.PdfCell(u.getActivo(), FontFactory.getFont("arial", 10, Font.NORMAL)));
    ...
    public String print() {
        ...
        try {
            ...
            document.open();
                document.add(ReportUtils.paragraph("UNIDAD", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
            ...
            document.add(ReportUtils.paragraph("Unidad: " + unidad.getIdunidad(), FontFactory.getFont("arial",12, Font.NORMAL), Element.ALIGN_JUSTIFIED));
            
            document.add(ReportUtils.paragraph("Activo: " + unidad.getActivo(), FontFactory.getFont("arial", 12, Font.NORMAL), Element.ALIGN_JUSTIFIED));
