            ...
            switch (getSearch()) {
                ...
                case "idsolicitud":
                    if (getValueSearch() != null) {
                        ...
                        doc = new Document("idsolicitud", solicitudSearch.getIdsolicitud()).append("tiposolicitud.idtiposolicitud", "ADMINISTRATIVO").append("activo", "si");
                        solicitudList = solicitudRepository.findPagination(doc, page, rowPage, new Document("idsolicitud", -1));
                    } else {
                ...
                case "estatus":
                    ...
                    doc = new Document("estatus.idestatus", estatus.getIdestatus()).append("activo", "si").append("tiposolicitud.idtiposolicitud", "ADMINISTRATIVO");
                    solicitudList = solicitudRepository.findPagination(doc, page, rowPage, new Document("idsolicitud", -1));
    ...
    public String edit() {
        try {
            ...
            repositoryRevisionHistory.save(revisionHistoryServices.getRevisionHistory(solicitud.getIdsolicitud().toString(), jmoordb_user.getUsername(),
                    "update solicitud manual administrativo", "solicitud", solicitudRepository.toDocument(solicitud).toString()));
