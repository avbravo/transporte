...
@Getter
@Setter
public class CambiarConductorViajeController implements Serializable, IController {
...
// <editor-fold defaultstate="collapsed" desc="constructor">
    public CambiarConductorViajeController() {
    }
...
//                  //Agrega solo los que tienen el tipo de datos  
    ...
    public List<Conductor> completeConductor(String query) {
        ...
        try {
            conductorSelected = conductorNuevo;
            ...
            if (!temp.isEmpty()) {
                ...
                if (conductorList == null || conductorList.isEmpty()) {
                    validos.forEach((v) -> {
                        if (v.getIdconductor().equals(viajeIda.getConductor().getIdconductor())) {
...
// </editor-fold>
    ...
    public Boolean isCambioValido() {
        try {
            if (conductorNuevo == null || conductorNuevo.getIdconductor() == null) {
                return false;
            }
            if (!conductorNuevo.getIdconductor().equals(viajeIda.getConductor().getIdconductor())) {
                return true;
            }
    ...
    public String save() {
        try {
            ...
            if (conductorNuevo == null || conductorNuevo.getNombre() == null || conductorNuevo.getNombre().equals("")) {
                JsfUtil.warningMessage(rf.getMessage("warning.seleccioneunconductor"));
                return null;
            }
            viajeIda.setConductor(conductorNuevo);
            ...
            if (viajeRepository.update(viajeIda)) {
                ...
                revisionHistoryRepository.save(revisionHistoryServices.getRevisionHistory(viajeIda.getIdviaje().toString(), jmoordb_user.getUsername(),
                        "uddate cambio de conductor", "viaje", viajeRepository.toDocument(viajeIda).toString()));
