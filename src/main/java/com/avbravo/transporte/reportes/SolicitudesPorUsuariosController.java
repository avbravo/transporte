...
// <editor-fold defaultstate="collapsed" desc="move(Integer page)">
    ...
    public String printAll() {
        ...
        try {
            ...
            document.open();
            document.add(ReportUtils.paragraph("SOLICITUDES POR USUARIOS", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
document.add(ReportUtils.paragraph("", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
            document.add(ReportUtils.paragraph("", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
            document.add(ReportUtils.paragraph("USUARIO "+usuarioSearch.getNombre(), FontFactory.getFont("arial", 10, Font.BOLD), Element.ALIGN_CENTER));
