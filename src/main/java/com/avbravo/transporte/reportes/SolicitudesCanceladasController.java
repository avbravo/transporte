...
@Getter
@Setter
public class SolicitudesCanceladasController implements Serializable, IController {
...
// <editor-fold defaultstate="collapsed" desc="constructor">
    public SolicitudesCanceladasController() {
    }
...
// <editor-fold defaultstate="collapsed" desc="move(Integer page)">
    ...
    public void move(Integer page) {
        try {
         ...
         Bson filter = Filters.eq("estatus.idestatus", "CANCELADO");
    ...
    public String printAll() {
        ...
        try {
            ...
            document.open();
            document.add(ReportUtils.paragraph("SOLICITUDES CANCELADAS", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
