...
@Getter
@Setter
public class SolicitudesRechazadasController implements Serializable, IController {
...
// <editor-fold defaultstate="collapsed" desc="constructor">
    public SolicitudesRechazadasController() {
    }
...
// <editor-fold defaultstate="collapsed" desc="move(Integer page)">
    ...
    public void move(Integer page) {
        try {
         ...
         Bson filter = Filters.eq("estatus.idestatus", "RECHAZADO");
    ...
    public String printAll() {
        ...
        try {
            ...
            document.open();
            document.add(ReportUtils.paragraph("SOLICITUDES RECHAZADAS", FontFactory.getFont("arial", 12, Font.BOLD), Element.ALIGN_CENTER));
