...
public class RolAdministrador implements Serializable {
    ...
    public void enabled() {
        ...
        applicationMenu.getSugerencia().initialize(Boolean.TRUE);
        applicationMenu.getTipogira().initialize(Boolean.TRUE);
        ...
        applicationMenu.getViaje().initialize(Boolean.TRUE);
