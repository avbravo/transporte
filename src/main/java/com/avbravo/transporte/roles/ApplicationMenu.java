...
public class ApplicationMenu implements Serializable {
    ...
    private Boolean menuBarCalendario = false;
    ...
    public void setMenuBarCalendario(Boolean menuBarCalendario) {
        this.menuBarCalendario = menuBarCalendario;
    }
